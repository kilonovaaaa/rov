...
<img width="480" height="540" alt="image" src="https://github.com/user-attachments/assets/cd783037-33f2-4f8b-810b-31898342aef3" />


> DCDC降压电路所选择的SCT系列具有欠压锁定（选择用）、过温保护等功能，并且底部均设计了散热焊盘，可以有效散热，又芯片手册介绍详细，有利于选型，进而实现芯片性能，且SCT系列成本相对较低。
...
5. 485隔离通讯接口处，设计了专用的差模浪涌防护。
 ...
 2. 两个四合一电调通过适当长度的M4铜柱连接在画好其封装（四个定位孔）的圆形pcb上，置于舱底部，后续和剩余两块pcb相连，
  如果布局允许，可以在电调表面加贴导热硅胶垫，使其与舱体底板紧密贴合，被动水冷。

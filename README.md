...
### 1. 推进器
* 需考虑推力，体积，整体协调性等因素。
* 比如选择 6 个 ROVMAKER 24V 水下推进器（3 个正桨 3 个反桨）。

<div align="center">
  <img src="https://github.com/user-attachments/assets/38057388-4e0a-4360-a512-9ab2fa242a75" width="400" />
</div>

### 2. 电调
* 独立电调相较于内部集成电调，能够更稳定持续地输出推力，且成本低。
* 要能实现反转，即双向电调。
* 电调参数根据推进器参数（主要靠安培力做功）选择，推进器峰值电流 20A，电调最好选择 20A×1.2，又考虑舱内散热效果差，比如选择 2 个 RuiBet 45A 四合一电调（余下的两个接口做备用）。

<div align="center">
  <img src="https://github.com/user-attachments/assets/9a00fff0-6a99-4727-af38-a84e8b1d9a59" width="400" />
</div>
